...
{
    #region static class RSAEncryptionProvider
    /// <summary>
    /// RSA 加密提供程序
    /// </summary>
    ...
    /// RSA 加密提供程序
    /// </summary>
    internal class RSAEncryption : AbsAsymmetricProvider
    {
        /// <summary>
        /// 初始化一个<see cref="RSAEncryption"/>类型的实例
        /// </summary>
        public RSAEncryption() : this(OutType.Hex, RSAKeyType.Xml, Encoding.UTF8)
        {
        }
        /// <summary>
        /// 初始化一个<see cref="RSAEncryption"/>类型的实例
        /// </summary>
        public RSAEncryption(OutType outType = OutType.Hex, RSAKeyType keyType = RSAKeyType.Xml, Encoding encoding = null) : base(outType, keyType, encoding)
        {
        }
        ...
        public override AsymmetricKey CreateKey(RSAKeySizeType size = RSAKeySizeType.L2048)
        {
            ...
            return new AsymmetricKey() { PrivateKey = key.PrivateKey, PublickKey = key.PublickKey };
        }
        /// <summary>
        /// 使用指定公钥加密字符串
        /// </summary>
        ...
        {
            return RSAEncryptionProvider.SignData(source, privateKey, Encoding, OutType, RSAType.RSA, KeyType);
        }
    ...
    /// RSA256 加密提供程序
    /// </summary>
    internal class RSA2Encryption : RSAEncryption
    {
        /// <summary>
        /// 初始化一个<see cref="RSA2Encryption"/>类型的实例
        /// </summary>
        public RSA2Encryption() : this(OutType.Hex, RSAKeyType.Xml, Encoding.UTF8)
        {
        }
        /// <summary>
        /// 初始化一个<see cref="RSA2Encryption"/>类型的实例
        /// </summary>
        public RSA2Encryption(OutType outType = OutType.Hex, RSAKeyType keyType = RSAKeyType.Xml, Encoding encoding = null) : base(outType, keyType, encoding)
        {
        }
