...
namespace HCenter.Encryption
{
    ...
    /// </summary>
    internal sealed class HMACSHA256HashingProvider : HMACHashingBase
    {
        /// <summary>
    ...
    /// HMAC_SHA256 哈希加密提供程序
    /// </summary>
    internal class HMACSHA256Hashing : AbsHashingProvider
    {
        /// <summary>
        /// 初始化一个<see cref="HMACSHA256Hashing"/>类型的实例
        /// </summary>
        public HMACSHA256Hashing() : this(OutType.Hex, Encoding.UTF8)
        {
        }
        /// <summary>
        /// 初始化一个<see cref="HMACSHA256Hashing"/>类型的实例
        public HMACSHA256Hashing(OutType outType = OutType.Hex, Encoding encoding = null) : base(outType, encoding)
        {
        }
