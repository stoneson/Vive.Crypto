...
public class SM4JS {
    ...
    {
        int n = (int)((b[i] & 0xff) << 24 | (long)((b[i + 1] & 0xff) << 16) | (long)((b[i + 2] & 0xff) << 8) | (long)(b[i + 3] & 0xff) & 0xffffffffL);
        return n;
    }
    ...
    private int sm4Lt(int ka)
    {
        ...
        //System.out.println("ka:"+ka+",retVal:"+c);
        return c;
    }
    ...
    public void sm4_setkey_enc(SM4JS_Context ctx, byte[] key) throws Exception
    {
        if (ctx == null)
        {
    ...
    public void sm4_setkey_dec(SM4JS_Context ctx, byte[] key) throws Exception
    {
        if (ctx == null)
        {
            throw new Exception("ctx is null!");
    ...
    public byte[] sm4_crypt_ecb(SM4JS_Context ctx, byte[] input) throws Exception
    {
        if (input == null)
        {
    ...
    public byte[] sm4_crypt_cbc(SM4JS_Context ctx, byte[] iv, byte[] input) throws Exception
    {
